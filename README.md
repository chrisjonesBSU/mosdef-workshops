...
**Note about mBuild:** At the moment, the examples used in this workshop requires installing mBuild from source using the **develop branch**, as opposed to installing mBuild from conda-forge. 
